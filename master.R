...
#           - the size of each random draw, and 
...
source("scripts/simulations/4_get_model_fit_estimates.R")      # Table 3
source("scripts/simulations/5_bias_plot.R")                    # Figure 3
source("scripts/simulations/6_plots_of_benchmark_estimates.R") # Figure 2
