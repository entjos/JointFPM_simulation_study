...
#           - the number of Monte Carolo iterations
#           - the size of each randome draw, and 
...
source("scripts/simulations/4_get_model_fit_estimates.R")
source("scripts/simulations/5_bias_plot.R")
source("scripts/simulations/6_plots_of_benchmark_estimates.R")

# PART 2 EXAMPLE ---------------------------------------------------------------

source("scripts/example/1_analysis.R")
source("scripts/example/2_main_figures.R")
source("scripts/example/3_1_appendix_figures_S1_S2.R")
source("scripts/example/3_2_appendix_figure_S3.R")
